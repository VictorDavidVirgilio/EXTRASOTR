...
QState ActObj_playing(ActObj *me, QEvt const *e) {
  switch (e->sig) {
    ...
    case DOWN_SIG:
    case ALARM_ON_SIG: /* turn the alarm on */
    case ALARM_OFF_SIG: /* turn the alarm off */
    case CLOCK_12H_SIG: /* set the clock in 12H mode */
    case CLOCK_24H_SIG: /* set the clock in 24H mode */
    case ARM_SIG: {
        ActObj_dispatchToAllBombs(me,e);
        return Q_HANDLED();
    }
