...
bool keyboard_support(void) {
	...
	case 'u': { /*2020.12.11*/
        ...
        case 'o': { /*2020.12.11*/
            //static QEvt const upEvt = { PLAYER_UP_SIG,0,0 };
            //QF_PUBLISH(&upEvt,&l_kbd);
            BombEvt *be = Q_NEW(BombEvt,ALARM_ON_SIG);
#ifdef LMC_17000
            QACTIVE_POST(AO_ActObj,(QEvt *)be,&l_kbd);
#else
            QACTIVE_POST(AO_Tunnel,(QEvt *)be,&l_kbd);/* to the tunnel */
        ...
        case 'f': {
            BombEvt *be = Q_NEW(BombEvt,ALARM_OFF_SIG);
#ifdef LMC_17000
            QACTIVE_POST(AO_ActObj,(QEvt *)be,&l_kbd);
#else
            QACTIVE_POST(AO_Tunnel,(QEvt *)be,&l_kbd);
...
/*        case '0': {
        ...
        case 'a': {
            BombEvt *be = Q_NEW(BombEvt,CLOCK_12H_SIG);
#ifdef LMC_17000
            QACTIVE_POST(AO_ActObj,(QEvt *)be,&l_kbd);
#else
            QACTIVE_POST(AO_Tunnel,(QEvt *)be,&l_kbd);
        ...
        case 'b': {
            BombEvt *be = Q_NEW(BombEvt,CLOCK_24H_SIG);
#ifdef LMC_17000
            QACTIVE_POST(AO_ActObj,(QEvt *)be,&l_kbd);
#else
            QACTIVE_POST(AO_Tunnel,(QEvt *)be,&l_kbd);
